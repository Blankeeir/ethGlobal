import { ABIEvent, VET, VTHO, Revision, Address, HexUInt, ThorId, TransactionClause, TransactionBody as TransactionBody$1, ClauseOptions, ABIFunction, DeployParams, Transaction } from '@vechain/sdk-core';
import { AccessListish, TypedDataDomain, TypedDataField, JsonRpcApiProvider, JsonRpcPayload, JsonRpcResult, JsonRpcError } from 'ethers';
...
import { GetEventArgs, AbiEvent } from 'viem';
...
declare class AccountsModule {
     ...
     */
    getStorageAt(address: Address, position: ThorId, options?: AccountInputOptions): Promise<HexUInt>;
}
...
declare abstract class VeChainAbstractSigner implements VeChainSigner {
     ...
     */
    abstract signTypedData(domain: TypedDataDomain, types: Record<string, TypedDataField[]>, value: Record<string, unknown>, options?: SignTypedDataOptions): Promise<string>;
    /**
...
declare class Contract<TAbi extends Abi> {
     ...
     */
    constructor(address: string, abi: Abi, thor: ThorClient, signer?: VeChainSigner, transactionReceipt?: TransactionReceipt);
    /**
...
declare class ContractFactory<TAbi extends Abi> {
     ...
     * @param thor An instance of ThorClient to interact with the blockchain.
     */
    constructor(abi: Abi, bytecode: string, signer: VeChainSigner, thor: ThorClient);
    /**
...
declare class ContractsModule {
     ...
     */
    getBaseGasPrice(): Promise<ContractCallResult>;
}
 ...
 * @throws {JSONRPCInvalidParams}
 */
declare const ethGetUncleByBlockHashAndIndex: (params: unknown[]) => Promise<object>;
 ...
 * @throws {JSONRPCInvalidParams}
 */
declare const ethGetUncleByBlockNumberAndIndex: (params: unknown[]) => Promise<object>;
