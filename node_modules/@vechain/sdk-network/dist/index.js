...
var HttpClient = class {
  ...
  async http(method, path, params) {
    ...
    try {
      ...
      throw new import_sdk_errors.InvalidHTTPRequest(
        "HttpClient.http()",
    ...
    try {
      ...
      if (error instanceof import_sdk_errors.InvalidHTTPRequest) {
        throw error;
      }
      throw new import_sdk_errors.InvalidHTTPRequest(
        "HttpClient.http()",
...
function SyncPoll(pollingFunction, options) {
  if (options?.requestIntervalInMilliseconds !== void 0 && (options.requestIntervalInMilliseconds <= 0 || !Number.isInteger(options.requestIntervalInMilliseconds))) {
    throw new import_sdk_errors2.InvalidDataType(
      "SyncPoll()",
  ...
  return {
    ...
    waitUntil: async (condition) => {
      try {
        ...
        throw new import_sdk_errors2.PollExecution(
          "SyncPoll.waitUntil()",
...
var EventPoll = class extends import_events.EventEmitter {
  ...
  async _intervalLoop() {
    try {
      ...
      this.error = new import_sdk_errors3.PollExecution(
...
var getEventSubscriptionUrl = (baseURL, event, indexedValues, options) => {
  const ev = typeof event === "string" ? new import_sdk_core2.ABIEvent(event) : new import_sdk_core2.ABIEvent(event);
...
var resolveNames = async (thorClient, names) => {
  ...
  const [addresses] = await thorClient.contracts.executeCall(
    resolveUtilsAddress,
    import_sdk_core4.ABIItem.ofSignature(
      import_sdk_core4.ABIFunction,
...
var AccountDetail = class {
   ...
   */
  get vet() {
    return import_sdk_core5.VET.of(import_sdk_core5.Units.formatEther(import_sdk_core5.FixedPointNumber.of(this.balance)));
  }
  /**
   * Returns the energy balance of the account in {@link VTHO}.
   */
  get vtho() {
    return import_sdk_core5.VTHO.of(import_sdk_core5.Units.formatEther(import_sdk_core5.FixedPointNumber.of(this.energy)));
  }
  /**
...
var SOLIDITY_ERROR_SELECTOR = import_sdk_core7.Keccak256.of(import_sdk_core7.Txt.of("Error(string)").bytes).toString().slice(0, 10);
var SOLIDITY_PANIC_SELECTOR = import_sdk_core7.Keccak256.of(import_sdk_core7.Txt.of("Panic(uint256)").bytes).toString().slice(0, 10);

// src/thor-client/gas/helpers/decode-evm-error.ts
function decodeRevertReason(data) {
  if (data.startsWith(SOLIDITY_ERROR_SELECTOR))
    return import_sdk_core8.abi.decode(
      "string",
      "0x" + data.slice(SOLIDITY_ERROR_SELECTOR.length)
    );
  if (data.startsWith(SOLIDITY_PANIC_SELECTOR)) {
    const decoded = import_sdk_core8.abi.decode(
      "uint256",
    ...
    get: (_target, prop) => {
      return async (...args) => {
        if (contract.getSigner() === void 0) {
          throw new import_sdk_errors7.InvalidTransactionField(
            "getTransactProxy()",
  ...
  return new Proxy(contract.clause, {
    get: (_target, prop) => {
      return (...args) => {
        ...
        args = extractAdditionalOptionsResult.args;
        return {
          clause: import_sdk_core9.Clause.callFunction(
            import_sdk_core9.Address.of(contract.address),
            contract.getFunctionAbi(prop),
            args,
            import_sdk_core9.VET.of(
              transactionOptions.value ?? transactionValue ?? 0,
              import_sdk_core9.Units.wei
            ),
            {
              comment: clauseComment,
              includeABI: true
...
var Contract = class {
   ...
   */
  getFunctionAbi(prop) {
    return import_sdk_core10.ABIContract.ofAbi(this.abi).getFunction(prop.toString());
  }
  /**
  ...
  getEventAbi(eventName) {
    return import_sdk_core10.ABIContract.ofAbi(this.abi).getEvent(eventName.toString());
  }
};
...
var ContractFactory = class {
  ...
  async startDeployment(deployParams, options) {
    const deployContractClause = import_sdk_core11.Clause.deployContract(
      import_sdk_core11.HexUInt.of(this.bytecode),
      deployParams
    );
    ...
    this.deployTransaction = await this.thor.transactions.sendTransaction(
      import_sdk_core11.Transaction.decode(import_sdk_core11.HexUInt.of(signedTx.slice(2)).bytes, true)
    );
    return this;
  }
  /**
  ...
  async waitForDeployment() {
    if (this.deployTransaction?.id === void 0) {
      throw new import_sdk_errors8.CannotFindTransaction(
    ...
    if (transactionReceipt?.outputs[0]?.contractAddress === null || transactionReceipt?.outputs[0]?.contractAddress === void 0) {
      throw new import_sdk_errors8.ContractDeploymentFailed(
        "ContractFactory.waitForDeployment()",
...
var ContractsModule = class {
  ...
  async executeCall(contractAddress, functionAbi, functionData, contractCallOptions) {
    ...
    if (response[0].reverted) {
      ...
      return functionAbi.decodeOutputAsArray(import_sdk_core12.Hex.of(response[0].data));
    }
  }
  /**
  ...
  async executeMultipleClausesCall(clauses, options) {
    ...
    return response.map(
      (res, index) => clauses[index].functionAbi.decodeOutputAsArray(import_sdk_core12.Hex.of(res.data))
    );
  }
  /**
  ...
  async executeTransaction(signer, contractAddress, functionAbi, functionData, options) {
    const id = await signer.sendTransaction({
      clauses: [
        ...
        import_sdk_core12.Clause.callFunction(
          import_sdk_core12.Address.of(contractAddress),
          functionAbi,
          functionData,
          import_sdk_core12.VET.of(options?.value ?? 0, import_sdk_core12.Units.wei)
        )
      ],
      gas: options?.gas,
  ...
  async getBaseGasPrice() {
    return await this.executeCall(
      ...
      import_sdk_core12.ABIContract.ofAbi(BUILT_IN_CONTRACTS.PARAMS_ABI).getFunction("get"),
...
var DebugModule = class {
  ...
  async traceContractCall(input, name) {
    if (input.contractInput?.to !== void 0 && input.contractInput.to !== null && !import_sdk_core13.Address.isValid(input.contractInput.to)) {
      throw new import_sdk_errors9.InvalidDataType(
...
var GasModule = class {
  ...
  async estimateGas(clauses, caller, options) {
    ...
    const intrinsicGas = Number(import_sdk_core14.Transaction.intrinsicGas(clauses).wei);
    ...
    if (eventAbis !== void 0) {
      ...
      eventLogs.forEach((log) => {
        ...
        if (eventAbi === void 0 || eventAbi === null) {
          throw new import_sdk_errors11.InvalidAbiItem(
        ...
        log.decodedData = eventAbi.decodeEventLogAsArray({
          data: import_sdk_core15.Hex.of(log.data),
          topics: log.topics.map((topic) => import_sdk_core15.Hex.of(topic))
        });
        result.push(log);
      });
    }
...
var TransactionsModule = class {
  ...
  async sendRawTransaction(raw) {
    ...
    try {
      import_sdk_core16.Transaction.decode(import_sdk_core16.HexUInt.of(raw.slice(2)).bytes, true);
    } catch (error) {
      throw new import_sdk_errors13.InvalidDataType(
        "TransactionsModule.sendRawTransaction()",
  ...
  async buildTransactionBody(clauses, gas, options) {
    ...
    if (genesisBlock === null)
      throw new import_sdk_errors13.InvalidTransactionField(
...
var _getDelegationSignature = async (tx, delegatorUrl, originAddress, httpClient) => {
  ...
  try {
    ...
    return import_sdk_core17.HexUInt.of(response.signature.slice(2)).bytes;
  } catch (error) {
    throw new import_sdk_errors14.NotDelegatedTransaction(
...
var VeChainAbstractSigner = class {
  ...
  async populateTransaction(transactionToPopulate) {
    if (this.provider === null) {
      throw new import_sdk_errors15.JSONRPCInvalidParams(
  ...
  _buildClauses(transaction) {
    return transaction.to !== void 0 && transaction.to !== null ? (
      ...
      [
        import_sdk_core18.Clause.deployContract(
          import_sdk_core18.HexUInt.of(transaction.data ?? 0)
        )
      ]
    );
  }
...
var VeChainPrivateKeySigner = class _VeChainPrivateKeySigner extends VeChainAbstractSigner {
  ...
  async _signFlow(transaction, delegator, thorClient) {
    ...
    return delegator !== null ? await this._signWithDelegator(
      ...
      import_sdk_core19.Transaction.of(populatedTransaction).sign(this.privateKey).encoded
    ).toString();
  }
  /**
  ...
  async _signWithDelegator(unsignedTransactionBody, originPrivateKey, thorClient, delegatorOptions) {
    ...
    const unsignedTx = import_sdk_core19.Transaction.of(unsignedTransactionBody);
    if (delegatorOptions?.delegatorPrivateKey !== void 0)
      return import_sdk_core19.Hex.of(
        import_sdk_core19.Transaction.of(unsignedTransactionBody).signWithDelegator(
          originPrivateKey,
          import_sdk_core19.HexUInt.of(delegatorOptions?.delegatorPrivateKey).bytes
        ).encoded
      ).toString();
    ...
    return import_sdk_core19.Hex.of(
      import_sdk_core19.Transaction.of(unsignedTx.body, signature).encoded
    ).toString();
  }
};
    ...
    super(
      [...Array(count).keys()].map((path) => {
        ...
        return {
          ...
          publicKey: import_sdk_core21.Secp256k1.derivePublicKey(privateKeyBuffer),
    ...
    for (const jsonRpcPayload of requestPayloadArray) {
      try {
        ...
        responses.push({
          ...
          error: {
            code: -32603,
            message: (0, import_sdk_errors18.stringifyData)(e)
          }
        });
      }
    }
...
var getTransactionIndexIntoBlock = (block, hash) => {
  ...
  if (idx === -1) {
    throw new import_sdk_errors19.InvalidDataType(
...
var ethBlockNumber = async (thorClient) => {
  try {
    ...
    throw new import_sdk_errors20.JSONRPCInternalError(
      "eth_blockNumber()",
      -32603,
      'Method "eth_blockNumber" failed.',
      {
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors20.stringifyData)(e)
      }
    );
  }
};
...
var ethChainId = async (thorClient) => {
  try {
    ...
    if (genesisBlock?.id === null || genesisBlock?.id === void 0) {
      throw new import_sdk_errors21.JSONRPCInvalidParams(
        "eth_chainId()",
        -32602,
...
var ethGetBalance = async (thorClient, params) => {
  ...
  try {
    ...
    throw new import_sdk_errors22.JSONRPCInternalError(
      ...
      {
        params: (0, import_sdk_errors22.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
...
var ethGetBlockByHash = async (thorClient, params) => {
  ...
  try {
    ...
    throw new import_sdk_errors30.JSONRPCInternalError(
      "eth_getBlockByHash()",
      -32603,
...
var ethSendTransaction = async (thorClient, params, provider) => {
  ...
  try {
    ...
    throw new import_sdk_errors34.JSONRPCInternalError(
      "eth_sendTransaction()",
      -32603,
...
var ethSubscribe = async (thorClient, params, provider) => {
  ...
  if (params[0] !== "newHeads" /* NEW_HEADS */ && params[0] !== "logs" /* LOGS */) {
    throw new import_sdk_errors37.JSONRPCInvalidParams(
      "ethSubscribe()",
      -32602,
  ...
  if (provider.getPollInstance() === void 0) {
    ...
    if (block !== void 0 && block !== null) {
      ...
      throw new import_sdk_errors37.JSONRPCServerError(
        "ethSubscribe()",
        -32e3,
...
var ethUnsubscribe = async (params, provider) => {
  let result = false;
  if (provider === void 0) {
    throw new import_sdk_errors38.JSONRPCInternalError(
      "ethSubscribe()",
      -32603,
      'Method "ethSubscribe" failed. Provider is not defined.',
      {
...
var debugTraceTransaction = async (thorClient, params) => {
  ...
  if (!import_sdk_core36.ThorId.isValid(transactionId)) {
    throw new import_sdk_errors39.InvalidDataType(
      "debug_traceTransaction()",
      "Invalid transaction ID given as input. Input must be an hex string of length 64.",
      { transactionId }
    );
...
var debugTraceCall = async (thorClient, params) => {
  if (params.length !== 3 || typeof params[0] !== "object" || typeof params[1] !== "string" || typeof params[2] !== "object")
    throw new import_sdk_errors40.JSONRPCInvalidParams(
      "debug_traceCall",
      -32602,
  ...
  try {
    ...
    throw new import_sdk_errors40.JSONRPCInternalError(
      ...
      'Method "debug_traceCall" failed.',
      {
        ...
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors40.stringifyData)(e)
      }
    );
  }
};
...
var ethGetBlockTransactionCountByNumber = async (thorClient, params) => {
  if (params.length !== 1 || typeof params[0] !== "string")
    throw new import_sdk_errors43.JSONRPCInvalidParams(
...
var ethGetTransactionByBlockHashAndIndex = async (thorClient, params) => {
  ...
  try {
    ...
    throw new import_sdk_errors44.JSONRPCInternalError(
      "eth_getTransactionByBlockHashAndIndex()",
      -32603,
      'Method "eth_getTransactionByBlockHashAndIndex" failed.',
      {
        params: (0, import_sdk_errors44.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
...
var ethGetTransactionByBlockNumberAndIndex = async (thorClient, params) => {
  ...
  try {
    ...
    throw new import_sdk_errors45.JSONRPCInternalError(
      "eth_getTransactionByBlockNumberAndIndex()",
      -32603,
      'Method "eth_getTransactionByBlockNumberAndIndex" failed.',
      {
        params: (0, import_sdk_errors45.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors45.stringifyData)(e)
      }
    );
  }
};
...
var ethGetUncleByBlockHashAndIndex = async (params) => {
  if (params.length !== 2 || typeof params[0] !== "string" || !import_sdk_core38.ThorId.isValid(params[0]) || typeof params[1] !== "string")
...
var import_sdk_core39 = require("@vechain/sdk-core");
var import_sdk_errors48 = require("@vechain/sdk-errors");
var ethGetUncleCountByBlockHash = async (params) => {
  if (params.length !== 1 || typeof params[0] !== "string" || !import_sdk_core39.ThorId.isValid(params[0]))
    throw new import_sdk_errors48.JSONRPCInvalidParams(
...
var ethGetUncleCountByBlockNumber = async (params) => {
  if (params.length !== 1 || typeof params[0] !== "string")
    throw new import_sdk_errors49.JSONRPCInvalidParams(
...
var ethRequestAccounts = async (provider) => {
  ...
  if (accounts.length === 0)
    throw new import_sdk_errors50.JSONRPCInvalidParams(
      ...
      {
        provider: (0, import_sdk_errors50.stringifyData)(provider)
      }
    );
  return accounts;
};
...
var import_sdk_core40 = require("@vechain/sdk-core");
var ethSignTypedDataV4 = async (thorClient, params, provider) => {
  if (params.length !== 2 || typeof params[0] !== "string" || !import_sdk_core40.Address.isValid(params[0]) || typeof params[1] !== "object")
  ...
  try {
    ...
    throw new import_sdk_errors51.JSONRPCInternalError(
      "eth_signTypedDataV4",
      -32603,
      'Method "eth_signTypedDataV4" failed.',
      {
        params: (0, import_sdk_errors51.stringifyData)(params),
        url: thorClient.httpClient.baseURL
      },
      error
    );
...
var netListening = async (thorClient) => {
  try {
    ...
    throw new import_sdk_errors52.JSONRPCInternalError(
      "net_listening",
      -32603,
      'Method "net_listening" failed.',
      {
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors52.stringifyData)(e)
      }
    );
  }
};
...
var netPeerCount = async (thorClient) => {
  try {
    ...
    throw new import_sdk_errors53.JSONRPCInternalError(
      "net_peerCount",
      -32603,
      'Method "net_peerCount" failed.',
      {
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors53.stringifyData)(e)
      }
    );
  }
};
...
var import_sdk_core41 = require("@vechain/sdk-core");
var txPoolContentFrom = async (params) => {
  if (params.length !== 1 || typeof params[0] !== "string" || !import_sdk_core41.addressUtils.isAddress(params[0]))
    throw new import_sdk_errors54.JSONRPCInvalidParams(
      "eth_getBalance",
      -32602,
...
var import_sdk_core42 = require("@vechain/sdk-core");
var import_sdk_errors55 = require("@vechain/sdk-errors");
var debugTraceBlockByHash = async (thorClient, params) => {
  if (params.length !== 2 || typeof params[0] !== "string" || !import_sdk_core42.ThorId.isValid(params[0]) || typeof params[1] !== "object")
    throw new import_sdk_errors55.JSONRPCInvalidParams(
  ...
  try {
    ...
    throw new import_sdk_errors55.JSONRPCInternalError(
      "debug_traceBlockByHash()",
      -32603,
      'Method "debug_traceBlockByHash" failed.',
      {
        params: (0, import_sdk_errors55.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors55.stringifyData)(e)
      }
    );
  }
};
...
var debugTraceBlockByNumber = async (thorClient, params) => {
  if (params.length !== 2 || typeof params[0] !== "string" || typeof params[1] !== "object")
    throw new import_sdk_errors56.JSONRPCInvalidParams(
  ...
  try {
    ...
    throw new import_sdk_errors56.JSONRPCInternalError(
      "debug_traceBlockByNumber()",
      -32603,
      'Method "debug_traceBlockByNumber" failed.',
      {
        params: (0, import_sdk_errors56.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors56.stringifyData)(e)
      }
    );
  }
};
...
var ethGetBlockReceipts = async (thorClient, params) => {
  if (params.length !== 1 || typeof params[0] !== "string")
    throw new import_sdk_errors57.JSONRPCInvalidParams(
  ...
  try {
    ...
    throw new import_sdk_errors57.JSONRPCInternalError(
      "ethGetBlockReceipts()",
      -32603,
      'Method "ethGetBlockReceipts" failed.',
      {
        params: (0, import_sdk_errors57.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors57.stringifyData)(e)
      }
    );
  }
};
...
var ethSignTransaction = async (thorClient, params, provider) => {
  if (params.length !== 1 || typeof params[0] !== "object")
    throw new import_sdk_errors58.JSONRPCInvalidParams(
      "eth_signTransaction",
      -32602,
  ...
  try {
    ...
    throw new import_sdk_errors58.JSONRPCInternalError(
      "eth_signTransaction()",
      -32603,
      'Method "eth_signTransaction" failed.',
      {
        params: (0, import_sdk_errors58.stringifyData)(params),
        url: thorClient.httpClient.baseURL
      },
      error
    );
...
// src/provider/providers/vechain-provider/vechain-provider.ts
var import_sdk_core43 = require("@vechain/sdk-core");
var VeChainProvider = class extends import_events2.EventEmitter {
  ...
  constructor(thorClient, wallet, enableDelegation = false) {
    ...
    if (enableDelegation && wallet?.delegator === void 0) {
      throw new import_sdk_errors59.JSONRPCInvalidParams(
  ...
  async request(args) {
    if (!Object.values(RPC_METHODS).map((key) => key.toString()).includes(args.method)) {
      throw new import_sdk_errors59.JSONRPCMethodNotFound(
  ...
  async getLogsRPC() {
    const promises = Array.from(
      ...
      const currentBlock = import_sdk_core43.HexInt.of(
        this.subscriptionManager.currentBlockNumber
      ).toString();
      const filterOptions = {
  ...
  async request(args) {
    try {
      if (this.debug) {
        ...
        (0, import_sdk_logging37.VeChainSDKLogger)("log").log({
          title: `Sending request - ${args.method}`,
          messages: [
            `params: ${(0, import_sdk_errors60.stringifyData)(args.params)}`,
            `accounts: ${(0, import_sdk_errors60.stringifyData)(accounts)}`,
            `delegator: ${(0, import_sdk_errors60.stringifyData)(delegator)}`,
      ...
      if (this.debug) {
        (0, import_sdk_logging37.VeChainSDKLogger)("log").log({
          ...
          messages: [`result: ${(0, import_sdk_errors60.stringifyData)(result)}`]
        });
      }
      return result;
    } catch (error) {
      if (this.debug) {
        (0, import_sdk_logging37.VeChainSDKLogger)("error").log(
          new import_sdk_errors60.JSONRPCInternalError(
            args.method,
            -32603,
      ...
      if (error instanceof import_sdk_errors60.VechainSDKError) {
