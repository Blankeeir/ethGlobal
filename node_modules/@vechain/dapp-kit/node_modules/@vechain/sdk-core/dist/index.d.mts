import { ParamType, BytesLike, ethers } from 'ethers';
export { ethers as vechain_sdk_core_ethers } from 'ethers';
import * as s_bip32 from '@scure/bip32';
import { AbiParameter, AbiFunction, AbiEvent, Abi, DecodeEventLogReturnType, EncodeEventTopicsReturnType, DecodeFunctionDataReturnType, DecodeFunctionResultReturnType } from 'viem';
...
declare abstract class ABIItem extends ABI {
    readonly signature: ABIItemType;
     ...
     **/
    constructor(signature: string | ABIItemType);
    static ofSignature<T extends ABIItem>(ABIItemConstructor: new (signature: string) => T, signature: string): T;
    static ofSignature<T extends ABIItem>(ABIItemConstructor: new (signature: ABIItemType) => T, signature: ABIItemType): T;
    /**
 ...
 * @extends ABIItem
 */
declare class ABIEvent extends ABIItem {
     ...
     */
    static parseLog(abi: Abi, eventData: ABIEventData): DecodeEventLogReturnType;
    /**
     * Decode event log data using the event's ABI.
     *
     ...
     * @throws {InvalidAbiDataToEncodeOrDecode}
     */
    decodeEventLog(event: ABIEventData): DecodeEventLogReturnType;
    /**
     ...
     */
    encodeEventLog<TValue>(dataToEncode: TValue[]): ABIEventData;
    /**
     ...
     * @throws {InvalidAbiDataToEncodeOrDecode}
     */
    encodeFilterTopics<TValue>(valuesToEncode: TValue[]): EncodeEventTopicsReturnType;
    /**
     ...
     * @throws {InvalidAbiDataToEncodeOrDecode}
     */
    encodeFilterTopicsNoNull<TValue>(valuesToEncode: TValue[]): Array<string | undefined>;
}
 ...
 * @extends ABIItem
 */
declare class ABIFunction extends ABIItem {
     ...
     * @throws {InvalidAbiDataToEncodeOrDecode}
     */
    decodeData(data: Hex): DecodeFunctionDataReturnType;
    /**
     ...
     * ```
     */
    decodeResult(data: Hex): DecodeFunctionResultReturnType;
    /**
...
declare class ABIContract extends ABI {
     ...
     * @throws {InvalidAbiDataToEncodeOrDecode}
     */
    encodeFunctionInput(functionName: string, functionData?: unknown[]): Hex;
    /**
     ...
     * @throws {InvalidAbiDataToEncodeOrDecode}
     */
    decodeFunctionInput(functionName: string, encodedFunctionInput: Hex): DecodeFunctionDataReturnType;
    /**
     ...
     *
     */
    decodeFunctionOutput(functionName: string, encodedFunctionOutput: Hex): DecodeFunctionResultReturnType;
    /**
     ...
     * @throws {InvalidAbiDataToEncodeOrDecode}
     */
    encodeEventLog(eventName: string, eventArgs: unknown[]): ABIEventData;
    /**
     ...
     * @throws {InvalidAbiDataToEncodeOrDecode}
     */
    decodeEventLog(eventName: string, eventToDecode: ABIEventData): DecodeEventLogReturnType;
    /**
     ...
     * @throws {InvalidAbiDataToEncodeOrDecode}
     */
    parseLog(data: Hex, topics: Hex[]): DecodeEventLogReturnType;
    /**
     *
...
declare class FixedPointNumber implements VeChainDataModel<FixedPointNumber> {
     ...
     */
    static of(exp: bigint | number | string, decimalPlaces?: bigint): FixedPointNumber;
    /**
...
declare class Transaction {
     ...
     * - {@link Blake2b256.of}.
     */
    getSignatureHash(delegator?: Address): Blake2b256;
    /**
...
type core_ABIContract = ABIContract;
declare const core_ABIContract: typeof ABIContract;
type core_ABIEvent = ABIEvent;
declare const core_ABIEvent: typeof ABIEvent;
type core_ABIFunction = ABIFunction;
