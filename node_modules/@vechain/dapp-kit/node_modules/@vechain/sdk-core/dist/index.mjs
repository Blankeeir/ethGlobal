...
var Hex = {
  ...
  canon: function(exp, bytes3) {
    ...
    if (REGEX_FOR_0X_PREFIX_HEX.test(exp)) {
      ...
      throw new InvalidDataType("Hex.canon()", "Arg 'n' not an hexadecimal expression." /* NOT_HEX */, {
        exp
      });
    }
...
function bigNumberOf(value) {
  ...
  if (bn.isNaN())
    throw new InvalidDataType9("unitUtils.bigNumberOf()", "Not a number.", {
...
import { InvalidHDNode as InvalidHDNode2 } from "@vechain/sdk-errors";
import { wordlist } from "@scure/bip39/wordlists/english";

// ../errors/src/model/base.ts
...
// ../errors/src/model/core/transaction.ts
...
// ../errors/src/model/network/http-client.ts
var HTTPClientError = class extends ErrorBase {
};

// ../errors/src/model/network/poll.ts
var PollExecutionError = class extends ErrorBase {
};

// ../errors/src/model/generic/function.ts
var NotImplementedError = class extends ErrorBase {
};

// ../errors/src/model/eip1193/eip1193.ts
...
// ../errors/src/model/json-rpc/json-rpc.ts
...
// ../errors/src/types/errorTypes.ts
...
// ../errors/src/utils/error-message-builder/error-message-builder.ts
...
// ../errors/src/utils/assert/assert.ts
...
// ../errors/src/available-errors/sdk-error.ts
...
// ../errors/src/available-errors/hdnode/hdnode.ts
