...
var Hex = {
  ...
  canon: function(exp, bytes3) {
    ...
    if (REGEX_FOR_0X_PREFIX_HEX.test(exp)) {
      ...
      throw new import_sdk_errors10.InvalidDataType("Hex.canon()", "Arg 'n' not an hexadecimal expression." /* NOT_HEX */, {
        exp
      });
    }
...
function isValid2(keystore4) {
  try {
    const copy = JSON.parse((0, import_sdk_errors25.stringifyData)(keystore4));
