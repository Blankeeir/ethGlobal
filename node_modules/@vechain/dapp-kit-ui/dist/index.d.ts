...
declare class AddressModal extends LitElement {
    ...
    language: string;
    walletConnectQRcode?: string;
    showCopiedMainIcon: boolean;
    showCopiedSecondaryIcon: boolean;
    constructor();
    disconnectedCallback(): void;
    onClose: () => void;
    render(): TemplateResult;
    private onCopyMainLabel;
    private onCopySecondaryLabel;
    private handleClose;
}
declare global {
    interface HTMLElementTagNameMap {
...
export { ANDROID_STORE_URL, AddressButton, AddressModal, BaseModal, Breakpoint, Button, Colors, ConnectButton, ConnectModal, ConnectModalManager, type ConnectModalManagerOptions, CustomWalletConnectModal, type CustomizedStyle, DAppKitUI, type DAppKitUIOptions, type EventArgs, type EventTypes, Font, Fonts, type I18n, IOS_STORE_URL, Inter, Modal, QrCodeUtil, SignConnectionCertificate, SourceCard, type SourceInfo, type ThemeMode, ThemeVariables, VEWORLD_WEBSITE, WalletConnectQrCode, WalletSources, addResizeListeners, createModalIfNotPresent, defaultI18n, dispatchCustomEvent, friendlyAddress, getPicassoImage, initButton, initModal, initModalAndButton, initStyles, isAndroid, isMobile, modalZIndex, subscribeToCustomEvent, useTranslate };
