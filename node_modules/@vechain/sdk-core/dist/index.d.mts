 ...
 */
declare class Hex extends String implements VeChainDataModel<Hex> {
    /**
     ...
     * @type {RegExp}
     */
    protected static readonly REGEX_PREFIX: RegExp;
    /**
 ...
 * @experiemntal
 */
declare class ThorId extends Hex {
    /**
     ...
     * @experimntal
     */
    static of(exp: bigint | number | string | Hex | Uint8Array): ThorId;
}
