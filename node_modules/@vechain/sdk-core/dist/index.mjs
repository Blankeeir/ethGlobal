...
var HexInt = class _HexInt extends Hex {
  ...
  get n() {
    ...
    throw new InvalidDataType2("HexInt.of", "not in the safe number range", {
      bi: `${bi}`,
      hex: this.toString()
    });
  }
...
var HexUInt = class _HexUInt extends HexInt {
  ...
  constructor(hi) {
    if (hi.sign >= Hex.POSITIVE) {
      ...
      throw new InvalidDataType3("HexUInt.constructor", "not positive", {
        hi
      });
    }
  }
...
// src/vcdm/Txt.ts
import { InvalidCastType as InvalidCastType2 } from "@vechain/sdk-errors";
...
import { InvalidAddress as InvalidAddress2 } from "@vechain/sdk-errors";
...
import { InvalidHDNode as InvalidHDNode2, InvalidHDNodeMnemonic as InvalidHDNodeMnemonic2 } from "@vechain/sdk-errors";
...
function sign3(transactionBody, signerPrivateKey) {
  if (!secp256k12.isValidPrivateKey(signerPrivateKey)) {
    throw new InvalidSecp256k1PrivateKey3(
