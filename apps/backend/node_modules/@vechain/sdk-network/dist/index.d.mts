import { ABIEvent, TransactionClause, vechain_sdk_core_ethers, TransactionBody as TransactionBody$1, Transaction, ClauseOptions, ABIFunction, DeployParams, VET, VTHO } from '@vechain/sdk-core';
...
import { AbiEvent, GetEventArgs } from 'viem';
...
declare class VeChainPrivateKeySigner extends VeChainAbstractSigner {
     ...
     * @param provider - The provider to connect to
     */
    constructor(privateKey: Uint8Array, provider: AvailableVeChainProviders | null);
    /**
     *  Returns a new instance of this Signer connected to //provider// or detached
     *  from any Provider if null.
     *
...
declare const DelegationHandler: (delegator?: SignTransactionOptions | null) => {
    ...
    getDelegationSignatureUsingUrl: (tx: Transaction, originAddress: string, httpClient: IHttpClient) => Promise<Uint8Array>;
};
...
declare class ContractsModule {
     ...
     */
    executeCall(contractAddress: string, functionAbi: ABIFunction, functionData: unknown[], contractCallOptions?: ContractCallOptions): Promise<ContractCallResult | string>;
    /**
